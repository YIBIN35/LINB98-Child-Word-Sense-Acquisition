# -*- coding: utf-8 -*-
"""LLM Labeling "Trunk" - Top50.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lbK6oFuoMF5CifAzI8sr8YibgQb3Z0b6
"""
...
print(top50_per_cluster["sentences"].head(10))
...
LLM_label = label_with_LLM(top50_per_cluster, trunk_glosses)

LLM_label.to_csv("LLM_label_output.csv", index=False)

print(top50_per_cluster[["sentences", "sense_label"]].head(25))
