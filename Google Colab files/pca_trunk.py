...
Original file is located at
    https://colab.research.google.com/drive/1chWpT54A9EGoE7OE2XzbCw5X8dx5ojOT
"""
...
df_sorted = df_trunk.sort_values(by=["sense_label"])
...
for sentence in cluster1_lst:
  vector = create_vectors_masked(sentence, "trunk")
...
plt.xlabel("PC1")
plt.ylabel("PC2")
plt.title("PCA Scatterplot (Trunk, masked)")
plt.legend()
plt.tight_layout()
plt.show()
...
unmasked_1 = []
for sentence in cluster1_lst:
  vector = create_vectors_unmasked(sentence, "trunk")
